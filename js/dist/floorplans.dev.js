...
function serenityFloorFunction(elmnt, id) {
  ...
  simpAnother(); // alert(serenityBHKS)
  // document.getElementById(id).classList.add('active');
  // document.getElementById("demo").innerHTML = "Hello World";
}

function serenityFaceFunction(elmnt) {
  serenityFACES = document.getElementById("serenitySelectFacing").value; // alert(serenityFACES)

  simpAnother();
}

function serenityBlockFunction(elmnt) {
  serenityBLOCKS = document.getElementById("serenitySelectBlock").value; // alert(serenityFACES)
